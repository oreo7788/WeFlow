...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  app: {
    ...
    onShuttingDown: (callback: () => void) => {
      ...
      ipcRenderer.on('app:shutting-down', listener)
      return () => ipcRenderer.removeListener('app:shutting-down', listener)
    },
  },
  ...
  chat: {
    ...
    getImageMessagesPage: (sessionId: string, offset?: number, limit?: number) =>
      ipcRenderer.invoke('chat:getImageMessagesPage', sessionId, offset, limit),
