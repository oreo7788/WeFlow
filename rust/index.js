        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@weflow/core-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@weflow/core-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@weflow/core-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@weflow/core-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
...
const { ImageDecryptService, decryptImageData, KeyService, generateImageXorKey, deriveDbKey, WcdbService, sanitizeTableName, ExportFormat, ExportTask, ExportService, AnalyticsService, version, initLogging, healthCheck, getSystemInfo } = nativeBinding
